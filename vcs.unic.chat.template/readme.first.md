...
## 3. Определите, как планируете использовать ВКС сервер:
   ...
   #### 3.1.2 По окончании установки необходимо установить выпущенный сертификат на клиентское устройство и в окружение где запущен сервис appserver приложения UnicChat, в связи с использованием самоподписанного сертификата.
