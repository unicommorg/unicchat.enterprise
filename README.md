...
- [Инструкция по скрипту установки unicchat.sh](#-unicchatsh)
      + [Описание скрипта](#--7)
         - [Основные функции в меню](#--8)
               ...
               + [🚀 Запуск сервисов](#--12)
               + [⚙️ Автоматизация](#--13)
         - [Детальное описание ключевых функций](#--14)
               + [🔗 Линковка сервисов](#--15)
               + [🌐 DNS конфигурация](#-dns-)
               + [🔐 SSL настройка](#-ssl-)
               + [🗄️ Конфигурация баз данных](#--16)
         - [Файлы конфигурации](#--17)
         - [Особенности работы](#--18)
         - [Рекомендуемая последовательность](#--19)
