...
<!-- TOC --><a name="21-dns-"></a>
#### 2.1 Зарегистрировать DNS адреса
...
DNS адреса myminio.unic.chat и myonlyoffice.unic.chat требуют явной настройки в файле /etc/hosts на сервере с NGINX. Пример записи:  
